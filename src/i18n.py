...
_TABLE: dict[str, dict] = {
    KOREAN: {
        ...
        "topic_heading": "📌 {name} · {count}건",
        "topic_note": "최근 {days}일 내 생성된 {name} 분야 저장소",
        "continued": "(이어서 {page}/{total})",
        "field_domains": "적용 분야",
    ...
    ENGLISH: {
        ...
        "topic_heading": "📌 {name} · {count}",
        "topic_note": "{name} repositories created in the last {days} days",
        "continued": "(continued {page}/{total})",
